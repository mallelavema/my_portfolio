          ...
          <div className="w-full h-44 bg-neutral-950/40 rounded-xl border border-white/[0.04] p-4 flex flex-col justify-between relative overflow-hidden font-mono text-[10px]">
            ...
            <div className="grid grid-cols-2 gap-3 my-2 relative z-10">
              ...
              <div className="p-2 rounded bg-white/[0.02] border border-white/[0.05]">
                ...
                <div className="w-full h-1 bg-pink-600/30 rounded-full mt-1.5 overflow-hidden">
                  <div className="w-[47%] h-full bg-pink-400" />
                </div>
              </div>
            </div>
      ...
      default:
        ...
        return (
          <div className="w-full h-44 bg-neutral-950/40 rounded-xl border border-white/[0.04] p-4 flex flex-col justify-between relative overflow-hidden font-mono text-[10px]">
            ...
            <div className="flex items-center justify-between relative z-10 border-b border-white/[0.05] pb-2">
              <span className="text-purple-400 font-bold tracking-widest">RAG_LANGCHAIN_CORE</span>
              <span className="text-pink-400 font-bold">VECTOR_INDEX</span>
            </div>

            {/* Neural index mapping visualization */}
            <div className="relative flex-1 flex items-center justify-center my-1">
              <div className="w-16 h-16 rounded-full border border-pink-500/20 flex items-center justify-center relative animate-pulse">
                ...
                {/* Orbital nodes */}
                <span className="absolute top-0 left-1 w-2 h-2 rounded-full bg-purple-400" />
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 relative z-10">
        ...
        <div className="mb-16">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="font-mono text-xs text-pink-400 uppercase tracking-widest">Selected Works</span>
          </div>
          ...
          {projectsData.map((project) => (
            ...
            >
              ...
              <div>
                ...
                {/* Title */}
                <h3 className="font-sans font-black text-xl text-white group-hover:text-pink-400 transition-colors duration-200">
                  {project.title}
                </h3>
              ...
              <div className="mt-6 pt-5 border-t border-white/[0.04] flex items-center justify-between">
                ...
                <div className="flex items-center gap-1 font-sans text-xs text-pink-400 font-semibold group-hover:underline">
        ...
        {selectedProject && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="absolute inset-0 bg-[#080412]/85 backdrop-blur-md"
            />
            ...
            <motion.div
              ...
              className="relative w-full max-w-2xl bg-[#0c081f] border border-white/[0.08] rounded-2xl shadow-2xl p-6 sm:p-8 overflow-y-auto max-h-[85vh] z-10"
              id="case-study-modal"
            >
              {/* Close Button */}
              <button
              ...
              <div className="font-mono text-xs text-pink-400 font-semibold mb-6">{selectedProject.date}</div>
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-white/[0.05]">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1.5 px-5 py-2.5 rounded-xl bg-gradient-to-r from-purple-600 to-pink-500 text-white font-medium text-xs hover:from-purple-500 hover:to-pink-400 shadow-md shadow-purple-600/10 hover:shadow-pink-500/20 transition-all duration-200"
                >
